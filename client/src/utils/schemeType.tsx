...
export type NotesProps<TChildProps = {}> = ApolloReactHoc.DataProps<NotesQuery, NotesQueryVariables> | TChildProps;
export function withNotes<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  NotesQuery,
  NotesQueryVariables,
  NotesProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, NotesQuery, NotesQueryVariables, NotesProps<TChildProps>>(NotesDocument, {
      alias: 'notes',
      ...operationOptions
    });
};
